      ...
      cells: [
        ...
        },
        {
          ...
          source: [
            ...
            "             except:\n",
            "                 print('⚠️ Could not auto-instantiate model (complex args). Please init manually.')\n",
            "        \n",
            "        if model:\n",
                        ...
                        {staticCheck.structuralHighlights.map((h, i) => (
                            ...
                            >
                                ...
                                <span className="opacity-50 text-[9px] ml-1 flex items-center gap-0.5">
                                    ...
                                    {h.lineNumbers.length} hit{h.lineNumbers.length > 1 ? 's' : ''} · L{h.lineNumbers[0]}
                                </span>
                            </button>
                        ))}
                    </div>
