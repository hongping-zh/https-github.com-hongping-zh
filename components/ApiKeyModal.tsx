...
import { Key, ExternalLink, ShieldCheck, Save, AlertTriangle } from 'lucide-react';
...
export const ApiKeyModal: React.FC<Props> = ({ isOpen, onSave, onClose, hasKey }) => {
        ...
        <div className="p-8">
          ...
          <div className="flex gap-3">
             {hasKey && (
                 <button 
                    onClick={onClose}
                    className="px-4 py-2.5 rounded-lg border border-gray-700 text-gray-400 hover:text-white hover:bg-gray-800 transition-colors text-sm font-medium"
                 >
                    Cancel
                 </button>
             )}
