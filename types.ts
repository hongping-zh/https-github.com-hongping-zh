...
export interface AnalysisResult {
  ...
  // NEW: FinOps / Cost Analysis
  estimatedHourlyCost: number; // e.g. $3.93 for A100
  costSavingsPer1MInference: number; // e.g. $50
